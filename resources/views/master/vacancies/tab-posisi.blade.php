<div class="row">
  <div class="col-6">
    ...
    <p>Master data untuk menambah lowongan kerja baru</p>
  </div>
  <div class="col-6">
    <button type="button" style="float: right; margin-left:8px;" class="btn btn-icon btn-primary rounded-pill"> <svg width="16" viewBox="0 0 24 24">
      ...
      </svg> <small> Export Data </small></button>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <button data-bs-toggle="modal" data-bs-target="#editModal{{ $row->vacancy_id }}" type="button" class="btn btn-icon btn-primary rounded-pill"> <svg width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button data-bs-toggle="modal" data-bs-target="#deleteModal{{ $row->vacancy_id }}" type="button" class="btn btn-icon btn-danger rounded-pill"><svg fill="none" xmlns="http://www.w3.org/2000/svg" width="16" viewBox="0 0 24 24">
