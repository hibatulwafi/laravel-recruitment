                    ...
                    <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                            <a href="{{ route('home') }}" class="navbar-brand d-flex align-items-center mb-3">
                                <!--Logo start-->
                                <img src="../../assets/images/icons/favicon.png" class="img-fluid gradient-main animated-scaleX" style="width: 80px;" alt="images">
                                <!--logo End-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 d-flex justify-content-between">
                                        <div class="form-check mb-3">
                                            <input wire:model="rememberMe" type="checkbox" class="form-check-input" id="customCheck1">
