...
<div class="card">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('st2.good') }}" enctype="multipart/form-data">
      <div class="row">
        @csrf
        ...
        <div class="col-6 d-flex justify-content-end align-items-center">
          ...
          &nbsp;
          <button class="btn btn-icon btn-danger rounded-pill lihat-data-kandidat" formaction="{{ route('st2.not_good') }}" style="width: 200px;" data-toggle="popover">Not Good</button>
            ...
            <table id="datatable" class="table table-striped" data-toggle="data-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">{{ $row->point  }}/20</td>
                  <td>{{ $row->name }}</td>
                  <td>{{ $row->phone }}</td>
                  <td>{{ $row->email }}</td>
