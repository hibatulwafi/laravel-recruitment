      ...
      <table id="datatable" class="table table-bordered table-hover" data-toggle="data-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-left">
              <a href="{{config('app.url').'/loker/seleksi-tahap-1/'.$row->segment}}" target="_BLANK">{{config('app.url').'/loker/seleksi-tahap-1/'.$row->segment}}</a>
            </td>
            <td class="text-center">
            ...
            <td class="text-center">
              ...
              <a href="{{ route('st1.detail', ['id' => $row->batch_id]) }}" class="btn btn-icon btn-info rounded-pill" data-toggle="popover" title="Seleksi Kandidat" data-content="Seleksi Kandidat" target="_BLANK">
                <svg class="icon-32" width="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
