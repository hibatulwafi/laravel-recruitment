...
<div class="card">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('st1.good') }}" enctype="multipart/form-data">
      <div class="row">
        @csrf
        ...
        <div class="col-6 d-flex justify-content-end align-items-center">
          ...
          &nbsp;
          <button class="btn btn-icon btn-danger rounded-pill lihat-data-kandidat" formaction="{{ route('st1.not_good') }}" style="width: 200px;" data-toggle="popover">Not Good</button>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <input style="zoom:1.3" type="checkbox" name="candidates_id[]" value="{{ $row->candidates_id }}" />
