    ...
    $('.lihat-data-kandidat').click(function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          link.href = "{{ url('/export/kandidat_bybatch')}}/" + primaryId; // URL untuk link
          link.textContent = 'Export Kandidat'; // Text pada link
          link.className = 'btn btn-primary'; // Class untuk tampilan link
